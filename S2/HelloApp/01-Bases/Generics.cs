partial class Program
{
  static void Generics()
  {
    ...
    WriteLine($"Tamanio del arreglo numerico: { GetIntArrayLength(numbers) } ");
    WriteLine($"Tamanio del arreglo nombres: { GetStringArrayLength(names) } ");

    // Usando un metodo generico
    WriteLine("\n usando un metodo generico:");
    WriteLine($"Tamanio del arreglo nombres con un metodo generico: { GetArrayLength(names) } ");
    WriteLine($"Tamanio del arreglo numerico con un metodo generico: {GetArrayLength(numbers)}");
